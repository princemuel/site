/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e970ad22df586aa5e58eaea62493a22)
// Runtime types generated with workerd@1.20260128.0 2026-01-12 global_fetch_strictly_public,nodejs_als,nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		OCTOKIT_REPO_OWNER: string;
		OCTOKIT_REPO_NAME: string;
		OCTOKIT_REPO_BRANCH: string;
		OCTOKIT_TOKEN: string;
		OCTOKIT_URL: string;
		OCTOKIT_VERSION: string;
		PUBLIC_SITE_URL: string;
		RESEND_ADDRESS: string;
		RESEND_AUDIENCE: string;
		RESEND_TOKEN: string;
		...
		USE_PARTIALS: string;
		UPSTASH_LIMIT_TOKEN: string;
		UPSTASH_LIMIT_WINDOW: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ASTRO_KEY" | "DATABASE_ENCRYPTION_KEY" | "DATABASE_TOKEN" | "DATABASE_URL" | "GOOGLE_DRIVE_FILE_ID" | "GOOGLE_DRIVE_TOKEN" | "OCTOKIT_REPO_OWNER" | "OCTOKIT_REPO_NAME" | "OCTOKIT_REPO_BRANCH" | "OCTOKIT_TOKEN" | "OCTOKIT_URL" | "OCTOKIT_VERSION" | "PUBLIC_SITE_URL" | "RESEND_ADDRESS" | "RESEND_AUDIENCE" | "RESEND_TOKEN" | "WEBHOOK_SECRET" | "SENTRY_AUTH_TOKEN" | "SENTRY_DSN_URL" | "SENTRY_PROJECT" | "USE_PARTIALS" | "UPSTASH_LIMIT_TOKEN" | "UPSTASH_LIMIT_WINDOW" | "UPSTASH_REDIS_REST_TOKEN" | "UPSTASH_REDIS_REST_URL" | "WAKATIME_TOKEN" | "OPENWEATHER_TOKEN">> {}
}
